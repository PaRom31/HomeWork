...
public class GameMap extends JPanel {
    ...
    private static final int STATE_WIN_PLAYER1 = 3;
    private static final int STATE_WIN_PLAYER2 = 4;
    ...
    private void update1(MouseEvent e) {
        ...
        if (gameCheck(DOT_HUMAN, STATE_WIN_PLAYER1)) {
            return;
        }
    ...
    private void update2(MouseEvent e) {
        ...
        if (gameCheck(DOT_HUMAN2, STATE_WIN_PLAYER2)) {
            return;
        }
    ...
    private void showGameOverMessage(Graphics g) {
        ...
        g.fillRect(0, getHeight() / 2 - 70, getWidth(), 110);
        g.setColor(Color.YELLOW);
        g.setFont(new Font("Times New Roman", Font.BOLD, 55));

        switch (stateGameOver) {
            case STATE_DRAW -> g.drawString("DRAW", getWidth() / 3, getHeight() / 2);
